...
char const*const PANEL_FILE = "/sys/class/backlight/intel_backlight/brightness";

char const*const LED_FILE = "/sys/class/leds/white/brightness";
            ...
            struct light_state_t const *state)
{
    ...
    ret = write_int(PANEL_FILE, brightness);
